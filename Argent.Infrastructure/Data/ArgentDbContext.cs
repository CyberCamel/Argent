...
using Timer = Argent.Core.Workflows.Shared.Timer;
using Argent.Core;
using ProtocolFormDefinition = Argent.Core.Forms.Protocol.V2.FormDefinition;

namespace Argent.Infrastructure.Data;

public class ArgentDbContext(DbContextOptions<ArgentDbContext> options) : IdentityDbContext<InternalUser, IdentityRole<Guid>, Guid>(options), IDataProtectionKeyContext
{
    ...
    public DbSet<FormSubmissionReceipt> FormSubmissionReceipts { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<FormDesignDraft>(entity =>
        {
            ...
            entity.Property(e => e.Definition)
                .HasConversion(
                    ...
                    v => JsonSerializer.Deserialize<ProtocolFormDefinition>(v, FormSerializer.Options) ?? new ProtocolFormDefinition())
                .HasColumnType("nvarchar(max)");
        ...
        builder.Entity<FormSubmissionReceipt>(entity =>
        {
            entity.ToTable("FormSubmissionReceipts");
