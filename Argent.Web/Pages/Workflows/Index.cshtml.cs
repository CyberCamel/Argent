...
public class IndexModel(ArgentDbContext _ctx, IResourceOwnershipService _ownership, IStringLocalizer<SharedResource> Localizer) : PageModel
{
    ...
    public async Task<IActionResult> OnPostCreate([FromForm] string name, [FromForm] string? description)
    {
        ...
        {
            ModelState.AddModelError("name", Localizer["Workflows.Index.NameRequired"]);
            return Page();
        }
